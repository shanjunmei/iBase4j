...
CREATE TABLE IF NOT EXISTS `sys_dept` (
  ...
  `sort_no` smallint(5) DEFAULT NULL COMMENT '排序号',
  `leaf_` smallint(1) DEFAULT NULL COMMENT '叶子节点(0:树枝节点;1:叶子节点)',
...
CREATE TABLE IF NOT EXISTS `sys_dic` (
  ...
  `sort_no` smallint(2) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sys_email_template` (
  ...
  `sort_` smallint(5) DEFAULT NULL COMMENT '排序号',
...
CREATE TABLE IF NOT EXISTS `sys_event` (
  ...
  `status_` smallint(3) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sys_role` (
  ...
  `role_type` smallint(1) NOT NULL DEFAULT '1' COMMENT '角色类型(1:业务角色;2:管理角色 ;3:系统内置角色)',
  `enable_` tinyint(1) NOT NULL DEFAULT '1',
  `remark_` varchar(1024) DEFAULT NULL COMMENT '备注',
  `create_by` bigint(20) DEFAULT NULL,
  `create_time` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `sys_user` (
  ...
  `sex_` smallint(1) NOT NULL DEFAULT '0' COMMENT '性别(0:未知;1:男;2:女)',
  `avatar_` varchar(500) DEFAULT NULL,
  `user_type` smallint(1) DEFAULT '1' COMMENT '人员类型(1:经办员;2:管理员;3:系统内置人员;)',
